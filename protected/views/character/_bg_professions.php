    ...
    if(is_array($professions))
        for($i = 0; $i < 2; $i++)
            if(!isset($professions[$i])): ?>
                <li>
                    <span class="icon"> 
                        <img src="http://media.blizzard.com/wow/icons/18/inv_misc_questionmark.jpg" width="12" height="12" />
                    </span>
            ...
            <?php else: ?>
                <li><div class="progress">
                        ...
                        <div>
                            <span> 
                                <img src="http://media.blizzard.com/wow/icons/18/<?php echo $professions[$i]['icon']; ?>.jpg" width="12" height="12" />
                            </span>
