...
<?php continue; endif; ?>
<div data-id="<?=($item['slot']-1)?>" data-type="<?=$item['slot']?>" class="slot slot-<?=$item['slot']?> <?=(($item['slot'] >= 6 && $item['slot'] <= 15 && $item['slot'] != 9 || $item['slot'] == 21) ? 'slot-align-right' : null)?> item-quality-<?=$item['quality']?>" id="slot-<?=$slot?>">
	<div class="slot-inner">
    	<div class="slot-contents">
            ...
            <div class="details">
                ...
                <span class="name color-q<?=$item['quality']?>">
                    <?=((($item['slot'] >= 6 && $item['slot'] <= 15 && $item['slot'] != 9 || $item['slot'] == 21) && !$item['enchant_id'] && $item['can_enchanted']) ? '<a href="javascript:;" class="audit-warning"></a>' : null)?>
