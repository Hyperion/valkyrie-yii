<div class="character-tooltip">
    ...
    <?php if($model->talentData['name'] != 'No Talents'): ?>
    <span class="character-talents">
        ...
        <span class="points"><?=$model->talentData[0]['count']?><ins>/</ins><?=$model->talentData[1]['count']?><ins>/</ins><?=$model->talentData[2]['count']?></span>
    <span class="clear"><!-- --></span>
    </span>
    <?php endif; ?>
</div>
