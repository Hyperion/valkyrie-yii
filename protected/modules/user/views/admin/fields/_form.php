...
<?php echo CHtml::beginForm(); ?>
	...
	<p class="note"><?php echo Core::requiredFieldNote(); ?>
	...
	<div class="row">
		...
		<?php echo (($model->id)
				...
				: CHtml::activeDropDownList($model,
					'field_type',
					ProfileField::itemAlias('field_type'))); ?>
	...
	<div class="row">
		...
		<p class="hint"><?php echo Yii::t('UserModule.user', 'Which related field should be rendered? This is used only for the DROPDOWNLIST field type.'); ?></p>
	</div>
