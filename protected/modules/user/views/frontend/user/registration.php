...
if (Yii::app()->user->hasFlash('success')):
    ...
    if (UserModule::doCaptcha('registration')):
        ...
        <div class="row">
            ...
            $this->widget('CCaptcha', array(
                'imageOptions' => array('class'         => 'offset3'),
                'buttonOptions' => array('class' => 'offset3 captchaLink'),
            ));
            ?>
        </div>
    ...
    <?php endif; ?>
    <div class="actions">
        <?php echo CHtml::submitButton(UserModule::t("Register"), array('class' => 'btn primary')); ?>
    </div>
