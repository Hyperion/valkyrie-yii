...
$this->breadcrumbs = array(
	...
	Yii::t('UserModule.user', 'Delete account'));

printf('<h2>%s</h2>', Yii::t('UserModule.user', 'Are you really sure you want to delete your Account?'));

printf('<p>%s</p>', Yii::t('UserModule.user', 'Please enter your password to confirm deletion:'));
