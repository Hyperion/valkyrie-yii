...
/**
 * PasswordValidator validates that the attribute value is a valid password.
 *
 * Future plans:
...
class PasswordValidator extends CValidator
{
  ...
  protected function validateAttribute($object, $attribute)
  {
    ...
    if ($this->minLen > 0)
    {
      ...
      {
        $message = $this->message !== null ? $this->message : Yii::t('UserModule.PasswordValidator',
