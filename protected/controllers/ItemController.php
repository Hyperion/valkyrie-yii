...
class ItemController extends Controller
{
    public function actionView($id)
    {
        ...
        $this->cs->registerCssFile('/css/wow/lightbox.css');
		...
		$this->cs->registerScriptFile('/js/local-common/third-party/swfobject.js', CClientScript::POS_END);
		...
		$this->cs->registerScriptFile('/js/local-common/lightbox.js', CClientScript::POS_END);
        $this->cs->registerScriptFile('/js/local-common/utility/model-rotator.js', CClientScript::POS_END);
        $this->cs->registerScriptFile('/js/local-common/utility/model-viewer.js', CClientScript::POS_END);
